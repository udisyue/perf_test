...
def build_message(nshead, in_param_dict):
    ...
    try:
        ...
        selection = in_param_dict["selection"]
        request_type = 1 if in_param_dict["request_type"] == '' else int(in_param_dict["request_type"])
    ...
    # request.user_info.request_type = 3
    # search_type
    ...
    request.detail_request.query_info.use_bk_cashback = True
