...
def main(in_param):
    ...
    try:
        ...
        return None
    # sign=ver_2_ci_20160926_co_20160927_bc_0_cl_0_of_0_adult_num_2_child_num_0#_417123, key=3047047277
    cmdKey = '../script/cache/bin/listKey %s %s %s %s %s %s %s %s %s' % ( in_param_dict["ver"], 
    ...
    cmdValue = '../script/cache/bin/listValue %s %s.%s %s' % ( 
    ...
    data["key"] = key
    try: 
        data["hotel_price"] = json.loads(value)
    except Exception as e:
        data["hotel_price"] = ""
