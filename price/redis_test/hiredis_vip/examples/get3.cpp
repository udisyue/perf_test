...
bool detail_find(const std::string& key, std::vector<char> &value) {
    ...
    if (!key.empty()){
        ...
        // const char *_rdsConnection = "10.39.135.22:5234"; 
        vector<string> rds;
        rds.push_back("10.39.135.17:5234");
        rds.push_back("10.39.135.17:5235");
        rds.push_back("10.39.135.17:5236");
        rds.push_back("10.39.135.22:5234");
        rds.push_back("10.39.135.22:5235");
        rds.push_back("10.39.135.22:5236");
        rds.push_back("10.39.136.17:5234");
        rds.push_back("10.39.136.17:5235");
        rds.push_back("10.39.136.17:5236");
        rds.push_back("10.39.136.23:5234");
        rds.push_back("10.39.136.23:5235");
        rds.push_back("10.39.136.23:5236");
        srand((unsigned)time(NULL));
        int index = rand()%12;
        const char *_rdsConnection = rds[index].c_str();
        ...
        // redisClusterContext *rds_ctx = redisClusterConnect(_rdsConnection, HIRCLUSTER_FLAG_ROUTE_USE_SLOTS | HIRCLUSTER_FLAG_ADD_SLAVE);
        return true;
